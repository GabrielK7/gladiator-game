...
public enum Ability {
    ATTACK("Attack is the ability to deal damage. Final damage is also affected by dextrity and skill."),
    ...
    HEALTH("Health is amount of damage you can take before you die. After each battle, health can be restored to full.");
